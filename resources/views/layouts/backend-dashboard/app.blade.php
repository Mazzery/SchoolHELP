        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner">
              ...
              <p>Recently Added School:</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="{{route('registerschool')}}" class="small-box-footer">Register <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            <div class="inner">
              ...
              <p>Recently Added Administrator</p>
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
            <a href="{{route('registerschooladmin')}}" class="small-box-footer">Register <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        {{-- <!-- ./col -->
        <div class="col-lg-3 col-6">
